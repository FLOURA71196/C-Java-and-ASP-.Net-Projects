...
/***
 * Android defines AsyncTask as “a class that extends the Object class to allow short operations to
 * run asynchronously in the background.” With “doInBackground” and “onPostExecute,”
 * Async can run tasks asynchronously on new threads.
 * Asynchronous tasks use: Params, parameters that are sent to the task upon execution.
 */
...
public class SendMail extends AsyncTask<Void,Void,Void> {
     ...
     * @param aVoid = result of background
     */
    @Override
     ...
     * @param params = parameters of the asynchronous task are passed to this step
     * @return = result of the computation must be returned by this step
     */
    @Override
